...
#ifndef ANDROID_SAMPLE_AQUASHADER_MOVE_H
#define ANDROID_SAMPLE_AQUASHADER_MOVE_H
...
class AquaShaderUV  : public AquaShaderBase{
...
#endif //ANDROID_SAMPLE_AQUASHADER_MOVE_H
